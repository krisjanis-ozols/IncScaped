...
export const StorieProvider = ({children}) =>{
    ...
    //       try {
    //             const response = await axios.get(`http://localhost/InkScaped/IncScaped/BackEnd/stories`);
